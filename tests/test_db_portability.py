...
from app.db.models import Work, Manifestation, db
...
def test_search_service_fallback_on_sqlite(app):
    ...
    from app.db.models import Work, Expression, Manifestation, db
...
def test_search_service_items_fallback_on_sqlite(app, normal_user_headers):
    ...
    from app.db.models import Work, Expression, Manifestation, Item, User, db
