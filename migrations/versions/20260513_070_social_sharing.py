...
def upgrade():
    ...
    def has_constraint(table_name, constraint_name, schema=None):
    ...
    if not inspector.has_table("shared_collections", schema="inventory"):
        op.create_table(
            "shared_collections",
