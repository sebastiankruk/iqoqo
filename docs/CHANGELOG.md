...
- **AI Sandbox agy Timeout on Startup**: Expanded egress proxy allowlist to include `*.googleusercontent.com:443`, `*.google.com:443`, `*.goog:443`, and `*.gstatic.com:443` so `agy` eligibility and profile avatar checks succeed without blocking background myKG extraction.
