...
- **Scanner Policy Control UX**: Relocated scanner policy selector ("Inventory", "Wishlist", "Catalog") to a floating `backdrop-blur-md` glassmorphism pill over the camera view in `frontend/app/scan/page.tsx`, eliminating duplicate effect hooks.
