 ...
 * @param {"book" | "cd" | "vinyl" | "audio" | "video" | "boardgame" | "puzzle"} [props.format="book"] Media format for aspect ratio
...
export function Viewfinder({
  ...
  const isSquare = isAudio || format === "video" || format === "boardgame" || format === "puzzle";
