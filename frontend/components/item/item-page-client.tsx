...
/** Props for ItemDetail component. */
 ...
 *
 * @param {ItemDetailProps} props - Component props.
 * @returns {JSX.Element} Item detail elements.
 */
...
/** Props for ItemPageClient. */
export interface ItemPageClientProps {
  itemId: number;
  initialItem?: Item | null;
}

/**
 * Client-side interactive wrapper for the Item page.
 *
