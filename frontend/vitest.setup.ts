  ...
  useTranslations: (namespace: string) => {
    const dictionaries: Record<string, Record<string, string>> = {
      ...
      StatsCards: {
        ...
        works: "Works",
        worksDesc: "Intellectual creations",
        expressions: "Expressions",
        expressionsDesc: "Realizations of works",
        manifestations: "Editions",
        manifestationsDesc: "Physical & digital formats",
        itemsFrbr: "Items",
        itemsFrbrDesc: "Single copies tracked",
        viewTop: "Top Tiles",
        viewStats: "Stats Tiles",
