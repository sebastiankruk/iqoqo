...
vi.mock("next-intl", () => ({
  ...
  useTranslations: (namespace: string) => {
    const dictionaries: Record<string, Record<string, string>> = {
      ...
      StatsCards: {
        items: "My Items",
        itemsGlobal: "All Items",
        itemsDesc: "Total in collection",
        itemsDescGlobal: "Total in repository",
        reading: "Reading",
        readingGlobal: "Being Read",
        readingDesc: "Currently active reads",
        readingDescGlobal: "Being read by users",
        wishList: "On Wish List",
        wishListGlobal: "On Wish Lists",
        wishListDesc: "On your list",
        wishListDescGlobal: "On user wish lists",
        lentOut: "Lent Out",
      ...
      scanner: {
        "topBar.title": "Scan New Item",
        "topBar.subtitle": "Position barcode or cover within the frame",
        "topBar.backAria": "Go back to library",
        "topBar.flashToggleAria": "Toggle flash",
        "topBar.policyShelf": "Shelf",
        "topBar.policyWishlist": "Wishlist",
        "topBar.policyCatalog": "Catalog Only",
        "topBar.policyShelfHint": "Adding directly to your personal shelf",
        "topBar.policyWishlistHint": "Adding to your wishlist",
        "topBar.policyCatalogHint": "Adding to shared catalog without adding to shelf",
        "formats.book": "Book",
        "formats.audiobook": "Audiobook",
        "formats.music": "Music",
        "formats.movie": "Movie",
        "formats.board_game": "Board Game",
        "formats.puzzle": "Puzzle",
        "disambiguation.title": "Which one did you mean?",
        "disambiguation.inCollection": "In Collection",
        "disambiguation.footerHint": "Found multiple matches in your local database. Please pick one to continue.",
        "disambiguation.closeAria": "Close",
        "successCard.found": "Successfully Found!",
        "successCard.addToShelf": "Add to Shelf",
        "successCard.addToWishlist": "Add to Wishlist",
        "successCard.addToCatalog": "Add to Catalog",
        "successCard.adding": "Adding...",
        "successCard.scanAnother": "Scan Another",
        "successCard.wrongItemEnterManually": "Wrong item? Enter Manually",
        "successCard.addedToShelf": '"{title}" added to your library!',
        "successCard.addedToWishlist": '"{title}" added to your Wishlist!',
        "successCard.addedToCatalog": '"{title}" added to Catalog!',
        ...
        "bottomSheet.lookingUpBarcode": "Looking up barcode {barcode}",
