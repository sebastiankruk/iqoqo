...
def import_models() -> None:
    ...
    # federation.py references auth (users.id FK on FederationFollower/Consent).
    from app.db import auth, settings, core, audio, video, games, social, roadmap, lending, federation  # noqa: F401, I001 # isort: skip
