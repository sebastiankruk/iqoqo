...
def create_expression(work_id: int, content_type: str = 'text', 
                     language: str = 'en', meta: Optional[Dict[str, Any]] = None) -> Expression:
    """
...
def create_manifestation(expression_id: int, isbn13: Optional[str] = None,
                        upc: Optional[str] = None, ean: Optional[str] = None,
                        publisher: Optional[str] = None, publication_date: Optional[Any] = None,
                        meta: Optional[Dict[str, Any]] = None) -> Manifestation:
    """
...
def create_item(manifestation_id: int, owner_id: str, 
               status: str = 'available', condition: Optional[str] = None,
               meta: Optional[Dict[str, Any]] = None) -> Item:
    """
...
def get_or_create_book_manifestation(isbn: str, title: str, 
                                     authors: Optional[list] = None,
                                     publisher: Optional[str] = None) -> Manifestation:
    """
