...
!(function (t, e) {
    ...
    function Ot(t) {
        ...
        return i && ("html" === ht(i) || ("body" === ht(i) && "static" === yt(i).position))
          ...
          (function (t) {
              ...
              for (let i = At(t); ft(i) && ["html", "body"].indexOf(ht(i)) < 0; ) {
                  const n = yt(i);
                  if (
                      "none" !== n.transform ||
                "none" !== n.perspective ||
                ...
                if (E) {
                    if (o || a) {
                        const k = "y" === y ? it : ot,
                            ...
                            X = E[y] + $ - V;
                        if (o) {
                            const Y = Dt(f ? Lt(S, K) : S, D, f ? kt(I, X) : I);
                            ((E[y] = Y), (C[y] = Y - D));
                        }
                        if (a) {
                            const Q = "x" === y ? it : ot,
    ...
    const ae = { placement: "bottom", modifiers: [], strategy: "absolute" };
    function le() {
